  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        My Journey as a Developer and Designer: 2021-2025
               </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          From 2021 to 2025, I have made significant strides in my career as both a developer and a designer. My path has been marked by
           continuous learning, hands-on experience, and
           the development of a diverse skill set that spans across web development, digital design, and project management.
        </p>
      </div>
